            ...
            <div className="main-colc-item-box">
              ...
              <div className="d-flex justify-content-between">
                <div className="d-flex gap-3">
                  ...
                  />
                  <div>
                    <h6 className="font-dm-sans font-700 mb-1">
                      The Futr Abstr
                    </h6>
            ...
            <div className="other-colc-items-box ps-lg-3">
              ...
              <div className="item d-flex">
                ...
                <div>
                  ...
                  <div className="d-flex gap-2 align-items-center user-info mb-3">
                    ...
                    <div>
                      <button className="btn d-flex gap-1 align-items-center">
                        <FaEthereum className="eth-icon" /> 0.25 ETH
                      </button>
                    </div>
                    <div>
                      <p>1 of 8</p>
                  ...
                  <a href="#f" className="btn btn-transparent font-averta-demo">
                    Place a bid
                  </a>
                </div>
              </div>
          ...
          <Col md={5} lg={4}>
            <div className="top-colc-box">
              <div className="heading-area">
                ...
                <h6 className="font-dm-sans font-700 text-purple">
                  Last 7 days
                </h6>
              </div>
              ...
              <div className="item d-flex align-items-center">
                ...
                <div className="colc-img position-relative">
                  <img
                    src={Topcol1}
                    alt="user"
                    className="img-fluid colc-img rounded-circle"
                  />
                  <img
                    src={Badge}
                    alt="badge"
                ...
                <div>
                  <h6 className="colc-name font-dm-sans font-500 mb-1">
                    CryptoFunks
                  </h6>
                  <p className="d-flex gap-1 align-items-center font-poppins font-600">
                    <FaEthereum className="eth-icon" /> 19,769.39
                  </p>
                </div>
                <h6 className="percentage font-poppins font-600 text-green">
                  +26.52%
                </h6>
              </div>
              {/* item 2 */}
              <div className="item d-flex align-items-center">
                ...
                <h6 className="percentage font-poppins font-600 text-red">
                  +26.52%
                </h6>
              </div>
              {/* item 3 */}
