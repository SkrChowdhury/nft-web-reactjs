    ...
    <footer>
      <Container>
          ...
          <Row>
            ...
            <Col xs={12} md={7} lg={4} className="mb-4 mb-md-0">
              <p className="logo mb-3 mb-md-4">
                <a
                  href="/f"
                  className="text-uppercase font-integralcfBold font-700"
                >
                  nfters
                </a>
              </p>
              ...
              <ul className="social-icons d-flex gap-2">
                <li>
                  <a href="#f" className="fb">
                    <FaFacebookF />
                  </a>
                </li>
                <li>
                  <a href="#f" className="twtr">
                    <FaTwitter />
                  </a>
                </li>
                <li>
                  <a href="#f" className="linkedin">
                    <FaLinkedinIn />
                  </a>
                </li>
              </ul>
            ...
            <Col xs={12} md={7} lg={4} className="mb-4 mb-md-0">
              ...
              <form className="subscribe-form">
                <div className="position-relative">
                  ...
                  />
                  <button className="btn btn-blue-lg subs-btn position-absolute">
                    Subscibe Now
                  </button>
                </div>
              </form>
        ...
        <div className="footer-bottom">
          <p className="text-center font-averta-demo">
